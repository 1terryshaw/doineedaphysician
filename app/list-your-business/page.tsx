...
export const metadata: Metadata = {
  ...
  description: `Add your physician to ${verticalConfig.name} for free. Free listing, takes about 2 minutes.`,
};
    ...
    <section className="bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-7xl mx-auto px-4 py-12"><div className="max-w-xl mx-auto">
        <header className="text-center mb-8">
          ...
          <p className="text-lg text-gray-700">Free listing. Takes about 2 minutes &mdash; we&rsquo;ll send you a magic link to manage it. Add your Google Business Profile link to earn a &ldquo;Reviews verified&rdquo; badge (shows once your Google rating loads).</p>
        </header>
